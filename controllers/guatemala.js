...
const GuatemalaGet = async (req = request, res = response) => {
    ...
    res.json({
        msg:'Metodo GET Guatemala - Fátima Liliana Córdova Torres',
        total,
        guatemala
    });
  }
  ...
  const GuatemalaPost = async (req, res = response) => {
    ...
    res.json({
        ok:true,
        msg:'Metodo POST Guatemala  - Fátima Liliana Córdova Torres',
        guatemala
    })
  }
  ...
  const GuatemalaPut = async (req, res = response) => {
    ...
    res.json({
        ok:true,
        msg:'Metodo PUT Guatemala - Fátima Liliana Córdova Torres',
        codigo, 
        nombreproyecto, 
        monto, 
        fecha
  ...
  const GuatemalaDelete = async (req, res = response) => {
    ...
    res.json({
        ok:true,
        msg:'Metodo DELETE Guatemala - Fátima Liliana Córdova Torres',
        guatemala
    })
  }
